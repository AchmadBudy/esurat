...
@section('content')
    ...
    <div class="col-xl-12 col-lg-12 col-md-12 col-12 layout-spacing">
        <div id="tableProgress" class="col-lg-12 col-12 layout-spacing">
            <a class="btn btn-primary btn-rounded mb-2" href="/surat-keluar/tambah">Tambah Data</a>
                                    ...
                                    <td class="text-center">
                                        <ul class="table-controls">
                                            <li>
                                                    ...
                                                    <a data-toggle="tooltip" data-placement="top" title="Edit" type="submit" class="btn btn-primary" href="/surat-keluar/edit/{{ $surat->id }}">
                                            ...
                                            <li>
                                                <form action="/surat-keluar/hapus" method="POST" onsubmit="return confirm('apakah yakin hapus surat?');">
                                                    @csrf
